...
#ifndef __BAFFLE__HPP
#define __BAFFLE__HPP
...
public:
	 ...
	 */
	Baffle(Smp::String8 name_ = "", simtg::NamedObject* parent_ = 0, Smp::String8 description_ = "");
	/**
	 ...
	 @param parent_         the model parent
	 */
	Baffle(Smp::String8 name_, Smp::String8 description_, Smp::IComposite* parent_);
	/**
	 Default Destructor
	 */
	virtual ~Baffle();
...
public:
	CLASS_INFO(Baffle,simtg::AsyncModelBase,SatSim)
